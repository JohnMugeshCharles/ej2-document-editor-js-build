this.default = function () {
    ...
    var container = new ej.documenteditor.DocumentEditorContainer({serviceUrl:hostUrl,
        enableToolbar: true, toolbarMode: 'Ribbon', height: '590px', showPropertiesPane: false,documentEditorSettings: { showRuler: true }
    });
